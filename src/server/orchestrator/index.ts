    ...
    try {
        ...
        await prisma.researchResult.upsert({
            ...
            create: {
                ...
                websiteData: intel.websiteData ? JSON.parse(JSON.stringify(intel.websiteData)) : undefined,
                socialMediaData: intel.socialData ? JSON.parse(JSON.stringify(intel.socialData)) : undefined,
                newsData: intel.newsData ? JSON.parse(JSON.stringify(intel.newsData)) : undefined,
                businessAnalysisData: intel.businessData ? JSON.parse(JSON.stringify(intel.businessData)) : undefined,
                mergedIntelligence: JSON.parse(JSON.stringify(intel)),
                opportunities: intel.businessData?.opportunities ? JSON.parse(JSON.stringify(intel.businessData.opportunities)) : undefined,
